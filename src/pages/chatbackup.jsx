...
const ChatUI = () => {
  ...
  const [activeChat, setActiveChat] = useState(staticChatData[0]);
          ...
          <div className="sticky top-0 z-50 flex items-center p-3 bg-white border-b border-gray-200 shadow-sm">
            ...
            <div className="flex items-center space-x-3 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="font-bold text-gray-800 text-sm truncate">{activeChat.name}</h2>
              ...
              <div className="p-4 border-t border-gray-100 bg-white">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 text-sm">You</h4>
                ...
                <div className="p-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h2 className="font-bold text-gray-800 text-lg">{activeChat.name}</h2>
