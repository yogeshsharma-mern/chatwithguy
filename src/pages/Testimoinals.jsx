...
const Testimoinals = () => {
    const cardsData = [
        ...
        {
            // image: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60%27,
            name: 'Jordan Lee',
            handle: '@jordantalks',
            date: 'June 5, 2025'
        },
        {
            // image: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60%27,
            name: 'Avery Johnson',
            handle: '@averywrites',
            date: 'May 10, 2025'
        },
    ...
    return (
       ...
       <div className='bg-linear-to-b from-[#2A0150] pt-10 to-[#090025] '>
             <div className="marquee-row w-full mx-auto max-w-5xl text-white overflow-hidden relative">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-noneto-transparent"></div>
                <div className="marquee-inner flex transform-gpu min-w-[200%] pt-10 pb-5">
                    {[...cardsData, ...cardsData].map((card, index) => (
                        <CreateCard key={index} card={card} />
                    ))}
                </div>
                <div className="absolute right-0 top-0 h-full w-20 md:w-40 text-white z-10 pointer-events-none  to-transparent"></div>
            </div>
       </div>
 
      <div className='bg-linear-to-b from-[#2A0150] to-[#090025] '>
              <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                ...
                <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10  pointer-events-none to-transparent"></div>
            </div>
      </div>
        </>
    )
...
const CreateCard = ({ card }) => (
    <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg bg-linear-to-b from-[#2A0150] to-[#090025] text-white transition-all duration-200 w-72 shrink-0">
        ...
        <p className="text-sm py-4 text-gray-600">Radiant made undercutting all of our competitors an absolute
            breeze.</p>
